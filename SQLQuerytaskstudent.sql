...
select * from department
insert into department values (11131,'it','FAHIMA')
insert into department values (10021,'HR','MALAK')
insert into department values(1122,'FINANCE','ISSRA')
insert into department values (11142,'ELECTRONIC','AISHA')
